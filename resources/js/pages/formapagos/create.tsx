...
export default function Create(){
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/admin/formapagos');
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Crear Forma de Pago" />
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold">Crear Nueva Forma de Pago</h1>
                        <p className="text-muted-foreground mt-2">
                            Completa los datos para registrar una nueva forma de pago
                        </p>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end gap-4 pt-6">
                                ...
                                <Button type="submit" disabled={processing}>
                                    ...
                                    {processing ? 'Guardando...' : 'Guardar Forma de Pago'}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
