...
export default function Create({ empleados, locales }: Props) {
    ...
    return (
        <AppLayout>
            <Head title="Nueva Asignación de Empleado a Locale" />
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Asigna un empleado a un locale
                        </p>
                    </div>
