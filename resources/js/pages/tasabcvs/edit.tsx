...
export default function Edit({ tasabcv }: { tasabcv: Tasabcv }){
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/tasabcvs/${tasabcv.id}`);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Editar Tasa BCV" />
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold">Editar Tasa BCV</h1>
                        <p className="text-muted-foreground mt-2">
                            Actualiza la información de la tasa de cambio
                        </p>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end gap-4 pt-6">
                                ...
                                <Button type="submit" disabled={processing}>
                                    ...
                                    {processing ? 'Actualizando...' : 'Actualizar Tasa BCV'}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
