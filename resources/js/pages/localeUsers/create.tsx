...
export default function Create({ users, locales }: { users: any[], locales: any[] }){
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/admin/locale-users');
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Crear Asignación Usuario-Locale" />
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2">
                            Asigna un usuario a un locale del sistema
                        </p>
                    </div>
                </div>
