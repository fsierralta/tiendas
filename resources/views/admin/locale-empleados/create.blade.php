        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Nueva Asignación de Empleado a Locale</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('localeEmpleados.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_locale" id="id_locale" class="form-control @error('id_locale') is-invalid @enderror" required>
                                        ...
                                        @foreach($locales as $locale)
                                            <option value="{{ $locale->id }}" {{ old('id_locale') == $locale->id ? 'selected' : '' }}>
                                                {{ $locale->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
